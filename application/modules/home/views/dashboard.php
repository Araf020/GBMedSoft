    ...
    <section id="container" class="">
        ...
        <header class="header white-bg">
            ...
            ?>
                <a href="home" class="logo">
                    <?php if (!empty($settings->logo_title)) { ?>
                        <img src="<?php echo $settings->logo_title; ?>" height="40">
                    <?php } else { ?>
                        <strong>
            ...
            <?php } else { ?>
                ...
                <a href="" class="logo">
                    <?php if (!empty($settings->logo_title)) { ?>
                        <img width="40" height="40" src="<?php echo $settings->logo_title; ?>">
                    <?php } else { ?>
                        <strong>
                            Hospital
                            <span>
                        ...
                        <?php if (in_array('attendance', $this->modules)) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="attendance"><i class="fa fa-bell-slash"></i><?php echo lang('attendance'); ?></a></li>


                                    <li><a href="attendance/report"><i class="fa fa-file"></i><?php echo lang('attendance'); ?> <?php echo lang('report'); ?></a></li>
