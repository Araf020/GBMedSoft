            ...
            <section class="panel-body">
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#diagnostic"><?php echo lang('diagnostic'); ?> <?php echo lang('test'); ?></a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#bill"><?php echo lang('bill_summary'); ?></a>
                        </li>
                        <li class="">
                                    ...
                                    <div>
                                        ...
                                        <form role="form" action="" id="editService" class="clearfix" method="post" enctype="multipart/form-data">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-12 pservice_div" id="service_options">
                                                    <u>
                                        ...
                                        <tbody id="diagnostic_table">
                                            ...
                                            ?>
                                                    <tr id="<?php echo $diagnostic_alloted->date; ?>-<?php echo $diagnostic_alloted->payment_procedure; ?>">
                                                        ...
                                                        <?php if (empty($allotment->d_time) || $this->ion_auth->in_group(array('admin'))) { ?>
                                                            <td class="no-print" id="delete-diagnostic-<?php echo date('d') . '-' . $diagnostic_alloted->id; ?>"><button type='button' class='btn btn-danger btn-xs btn_width delete_diagnostic' title='<?php echo lang('delete'); ?>' data-toggle='' data-id="<?php echo $diagnostic_alloted->id . "**" . $diagnostic_alloted->payment_procedure; ?>"><i class='fa fa-trash'></i></button></td>
                                                        <?php } ?>
                                                    </tr>
                                            <?php
                                                }
                                    ...
                                    <div>
                                        ...
                                        <form role="form" action="" id="editDiagnostic" class="clearfix" method="post" enctype="multipart/form-data">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-12 diagnostic_div" id="diagnostic_options">
                                                    <u>
                                    ...
                                    <div class="">
                                        <form role="form" action="" id="editCheckout" class="clearfix" method="post" enctype="multipart/form-data">
                                            ...
                                            <?php if (empty($allotment->d_time) || $this->ion_auth->in_group(array('admin'))) {
                                                ...
                                                <?php } else { ?>
                                                    <div class="col-md-12 label-warning"> All bill should be paid before discharge. Discharge Button will appear afetr payment.</div>
                                            <?php   }
                                            } ?>
                ...
                <section class="">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li> <?php echo lang('admission'); ?> <?php echo lang('date'); ?> <span class="label pull-right r-activity"><?php
                                                                                                                                    if (!empty($allotment->a_timestamp)) {
                                                                                                                                        echo date('M d, Y h:i A', $allotment->a_timestamp);
                                                                                                                                    }
                                                                                                                                    ?></span></li>
