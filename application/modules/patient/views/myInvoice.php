                ...
                <section class="col-md-4 no-print">
                    <div class="col-md-5 no-print option_button">
                        ...
                        <div class="text-center col-md-12 row">
                            ...
                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Patient'))) {
                            ...
                            ?>
                                ...
                                <a href="patient/download?id=<?php echo $payment->id; ?>" class="btn btn-info btn-sm detailsbutton pull-left download"><i class="fa fa-download"></i> <?php echo lang('download'); ?> </a>
                            <?php } ?>
