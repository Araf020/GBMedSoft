            ...
            <div class="bg_prescription">
                <?php if ($redirect != 'download') { ?>
                    <div class="panel-body">
                        <div class="col-md-8 pull-right text-right top_title">
                             <h5 class=''><?php
                                                if (!empty($doctor)) {
                                                    echo $doctor->name;
                                                } else {
                        ...
                        <div class="col-md-4 pull-left top_logo"> <img src="<?php echo $settings->logo; ?>" height="50">
                            <h4 class="doctor"><p>GRAMEEN BANK MEDICAL CENTER</p>  
                                <p>Mirpur-2, Dhaka-1216</p>
                                <p>Cell: 01713-5689</p></h4>
                        </div>
</div>
                <?php } else { ?>
                ...
                <?php if ($redirect != 'download') { ?>
                    <div class="col-md-12 clearfix description">
                        ...
                        <div class="col-md-5 left_panel">
                            ...
                            <div class="panel-body">
                                <div class="pull-left">
                                    <h5><strong><?php echo lang(''); ?> </strong> <br> <br> <?php echo $prescription->symptom; ?></h5>
                                </div>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="pull-left">
                                    <h5><strong><?php echo lang(''); ?></strong> <br> <br> <?php echo $prescription->note; ?></h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="panel-body" >
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td ><?php echo $single_medicine[4].', '.$single_medicine[3]?> </td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
                                ...
                                <div class="pull-center">
                                    <h5><strong><?php echo lang(''); ?> </strong> <br> <br> <?php echo $prescription->advice; ?></h5>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class=""><?php echo $this->medicine_model->getMedicineById($single_medicine[0])->name . ' - ' . $single_medicine[1]; ?> </td>
                                                        <td class=""><?php echo $single_medicine[4] . ' - ' . $single_medicine[3]; ?> </td>
