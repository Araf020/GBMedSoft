        ...
        <div class="col-md-12">
            <div class="row state-overview state_overview_design">
                <div class="col-md-8">
                    ...
                    <div class="panel-heading"> <?php echo date('F, Y', $first_minute) . ' ' . lang('pharmacy') . ' ' . lang('expense_report'); ?>
                        ...
                        <div class="col-md-1 pull-right no-print">
                            <a href="finance/pharmacy/dailyExpense?year=<?php echo $next_year; ?>&month=<?php echo $next_month; ?>">
                                <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                        <div class="col-md-1 pull-right no-print">
                            <a href="finance/pharmacy/dailyExpense?year=<?php echo $previous_year; ?>&month=<?php echo $previous_month; ?>">
