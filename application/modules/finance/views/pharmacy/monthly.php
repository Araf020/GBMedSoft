        ...
        <div class="col-md-12">
            <div class="row state-overview state_overview_design">
                <div class="col-md-8">
                    ...
                    <div class="panel-heading"> <?php echo date('Y', $first_minute) . ' ' .lang('pharmacy').' '. lang('sales_report'); ?> 
                        ...
                        <div class="col-md-1 pull-right no-print">
                            <a href="finance/pharmacy/monthly?year=<?php echo $next_year; ?>">
                                <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                        <div class="col-md-1 pull-right no-print">
                            <a href="finance/pharmacy/monthly?year=<?php echo $previous_year; ?>">
