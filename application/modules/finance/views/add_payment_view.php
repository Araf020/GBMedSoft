                                    ...
                                    <form role="form" id="editPaymentForm" class="clearfix" action="finance/addPayment" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-5 row">
                                            ...
                                            <!-- <div class="col-md-12 payment pad_bot">
                                                ...
                                                <label for="exampleInputEmail1"><?php echo lang('testpkz'); ?> </label>




                                                <select class="form-control js-example-basic-single"  id="selected_testpkz" name="test_package" value=''>

                                                    <option value=""><?php echo lang('select_testpkz'); ?></option>
                                                    <?php foreach ($test_packages as $package) { ?>
                                                        <option value="<?php echo $package->id; ?>" <?php
                                                                                                        if (!empty($payment->id)) {
                                                                                                           
                                                                                                                if ($package->id == $payment->test_package) {
                                                                                                                    echo 'selected';
                                                                                                                }
