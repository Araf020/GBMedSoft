...
class Finance extends MX_Controller
{
    ...
    function getDuePayment()
    {
        ...
        foreach ($data['payments'] as $payment) {
            ...
            $deposit = ' <a type="button" class="btn btn-xs btn-primary depositButton" title="' . lang('deposit') . '" data-toggle = "modal" data-id="' . $payment->id . '" data-from="' . $payment->payment_from . '"><i class="fa fa-money"> </i> ' . lang('deposit') . '</a>';
            $doctor_details = $this->doctor_model->getDoctorById($payment->doctor);
    ...
    function getdraftPayment()
    {
        ...
        foreach ($data['payments'] as $payment) {
            ...
            if ($this->ion_auth->in_group(array('admin', 'Accountant'))) {
                ...
                $options1 = ' <a class="btn btn-info btn-xs editbutton" title="' . lang('edit') . '" href="finance/editDraftPayment?id=' . $payment->id . '"><i class="fa fa-edit"> </i> ' . lang('edit') . '</a>';
            }
            ...
            if ($this->ion_auth->in_group(array('admin', 'Accountant'))) {
                ...
                $options3 = '<a class="btn btn-info btn-xs delete_button" title="' . lang('delete') . '" href="finance/deleteDraftPayment?id=' . $payment->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');"><i class="fa fa-trash"></i> ' . lang('delete') . '</a>';
            }
    ...
    function getCategoryList()
    {
        ...
        foreach ($data['payments_category'] as $category) {
            ...
            if ($this->ion_auth->in_group(array('admin', 'Accountant'))) {
                $options2 = ' <a class="btn btn-info btn-xs editbutton" title="' . lang('edit') . '" href="finance/editPaymentCategory?id=' . $category->id . '"><i class="fa fa-edit"> </i></a>';
                $options3 = '<a class="btn btn-info btn-xs delete_button" title="' . lang('delete') . '" href="finance/deletePaymentCategory?id=' . $category->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');"><i class="fa fa-trash"></i> ' . lang('delete') . '</a>';

                if (empty($category->report)) {
                    $template = '<a type="button" class="btn btn-xs btn-primary template" title="' . lang('template') . '" data-toggle = "modal" data-id="' . $category->id . '"><i class="fa fa-money"> </i>' .  lang('template') . '</a>';
                } else {
                    $template = '<a type="button" class="btn btn-xs btn-info template" title="' .  lang('template') . '" data-toggle = "modal" data-id="' . $category->id . '"><i class="fa fa-money"> </i>' . lang('edit') . ' ' . lang('template') . '</a>';
                }
            } else {
                $options2 = ' ';
                $options3 = ' ';
